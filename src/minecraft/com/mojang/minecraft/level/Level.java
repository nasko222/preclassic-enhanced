...
public class Level {
	...
	public boolean load() {
		try {
			DataInputStream e = new DataInputStream(new GZIPInputStream(new FileInputStream(new File("PreclassicEnhanced.dat"))));
	...
	public void save() {
		try {
			DataOutputStream e = new DataOutputStream(new GZIPOutputStream(new FileOutputStream(new File("PreclassicEnhanced.dat"))));
			e.write(this.blocks);
			e.close();
